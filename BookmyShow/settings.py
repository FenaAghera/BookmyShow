...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-%gh9#e_qfwm%)vo$bzwv02^%d(8nju-9w7z5ni+*z&q&&l@i62')
...
RAZORPAY_KEY_SECRET = os.environ.get('RAZORPAY_KEY_SECRET', 'your_razorpay_secret_key')
...
try:
    ...
    # Fallback to default storage if whitenoise not available
